...
<section class="product-detail">
    ...
    <div class="detail">
        <h2 class="product-name">Supra X</h2>
        <p class="product-short-des">Tipe Mesin	4-Langkah, SOHC, Silinder Tunggal <br>
Kapasitas Mesin	124,89 cc <br>
Sistem Suplai Bahan Bakar	PGM-FI (Programmed Fuel Injection) <br>
Diameter X Langkah	52,4 x 57,9 mm <br>
Tipe Tranmisi:  4 Speed, Rotary <br>
Daya Maksimum:	7,40 kW (10,1 PS) / 8.000 rpm <br>
Torsi Maksimum:	9,30 Nm (0,95 kgf.m) / 4.000 rpm <br>
Tipe Starter:	Starter Kaki dan Elektrik <br>
